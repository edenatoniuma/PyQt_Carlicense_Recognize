...
def run_ray_tune(model,
    ...
    Args:
        ...
        grace_period (int, optional): The grace period in epoch of the ASHA scheduler. Defaults to 10.
    ...
    default_space = {
        ...
        'warmup_epochs': tune.uniform(0.0, 5.0),  # warmup epoch (fractions ok)
    ...
    asha_scheduler = ASHAScheduler(time_attr='epoch',
                                   ...
                                   mode='max',
                                   max_t=train_args.get('epoch') or DEFAULT_CFG_DICT['epoch'] or 100,
