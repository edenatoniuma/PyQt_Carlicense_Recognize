...
HELP_MSG = \
    ...
    2. Use the Python SDK:
        ...
        # Use the model
        results = model.train(data="coco128.yaml", epoch=3)  # train the model
    ...
    3. Use the command line interface (CLI):
        ...
        - Train a detection model for 10 epoch with an initial learning_rate of 0.01
            yolo detect train data=coco128.yaml model=yolov8n.pt epoch=10 lr0=0.01
