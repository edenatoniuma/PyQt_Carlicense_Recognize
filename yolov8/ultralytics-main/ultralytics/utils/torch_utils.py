...
class ModelEMA:
    ...
    def __init__(self, model, decay=0.9999, tau=2000, updates=0):
        ...
        self.decay = lambda x: decay * (1 - math.exp(-x / tau))  # decay exponential ramp (to help early epoch)
...
class EarlyStopping:
    """Early stopping class that stops training when a specified number of epoch have passed without improvement."""
    ...
    def __init__(self, patience=50):
        ...
        Args:
            patience (int, optional): Number of epoch to wait after fitness stops improving before stopping.
        """
    ...
    def __call__(self, epoch, fitness):
        ...
        delta = epoch - self.best_epoch  # epoch without improvement
        self.possible_stop = delta >= (self.patience - 1)  # possible stop may occur next epoch
        stop = delta >= self.patience  # stop training if patience exceeded
        if stop:
            LOGGER.info(f'Stopping training early as no improvement observed in last {self.patience} epoch. '
