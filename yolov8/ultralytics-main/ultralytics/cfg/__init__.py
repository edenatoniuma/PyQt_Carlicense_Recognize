...
CLI_HELP_MSG = \
    ...
    1. Train a detection model for 10 epoch with an initial learning_rate of 0.01
...
CFG_INT_KEYS = ('epoch', 'patience', 'batch', 'workers', 'seed', 'close_mosaic', 'mask_ratio', 'max_det', 'vid_stride',
