...
class Detect:
    ...
    def __init__(self, weights='../yolov8/runs/detect/train4/weights/best.pt',
                 yaml=None, img_path="./imgs/original_img/img.png"):
    ...
    def run(self):
        ...
        for result in results:
            ...
            try:
                ...
                continue
            #  保存检测结果
            self.save_img("./imgs/detect", bbox, idx_ls, img_path, cls_list)
            ...
            # 写入车牌图像
            cv2.imwrite("imgs/license_plate/1.jpg", resize_license_plate)
